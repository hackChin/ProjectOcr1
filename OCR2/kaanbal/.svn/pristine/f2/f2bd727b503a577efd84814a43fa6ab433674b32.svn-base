...
public class Principal extends Fragment {
    ...
    CardView cardCalendar,cardDat,cardGroup,cardReport;
    DatePicker calendar;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        cardDat=(CardView)view.findViewById(R.id.cardDatos);
        cardGroup=(CardView)view.findViewById(R.id.cardGrupos);
        cardCalendar=(CardView)view.findViewById(R.id.cardCalendario);
        cardReport=(CardView)view.findViewById(R.id.cardReportes);
        calendar=(DatePicker)view.findViewById(R.id.calendar);
        txtcalendar=(TextView)view.findViewById(R.id.txtcalendario);
        ...
        cardDat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(),CapturarDatos.class);
                startActivity(intent);
            }
        });
        ...
        cardReport.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(),Reportes.class);
                startActivity(intent);
            }
        });
        ...
        cardGroup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(),Grupos.class);
                startActivity(intent);
            }
        });
